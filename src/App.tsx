...
import { Map as MapIcon, Navigation, Wifi, WifiOff, X, History } from 'lucide-react';
...
function App() {
  ...
  const handleSelectHistoryRoute = useCallback((historyItem: RouteHistoryItem) => {
  ...
  return (
    <div className="h-screen w-screen relative">
      ...
      >
        ...
        />
        {locationData && (
          <CurrentLocationMarker locationData={locationData} />
        )}
        ...
        {origin && destination && (
          <RouteControl origin={origin} destination={destination} />
        )}
      </MapContainer>
